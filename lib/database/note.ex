defmodule Database.Note do
  ...
  schema "notes_with_fk_fields" do
    ...
    belongs_to(:artist, Database.Artist)
    belongs_to(:album, Database.Album)
    belongs_to(:track, Database.Track)
  end
  ...
  def changeset(note, params) do
    ...
    |> check_constraint(:artist_id, name: "only_one_fk", message: "You must set one one foreign key: artist_id, album_id or track_id")
  end
end
